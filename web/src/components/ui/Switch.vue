...
<template>
  <label class="inline-flex cursor-pointer items-center gap-2 text-sm">
    ...
    >
      <SwitchThumb
        class="pointer-events-none block h-4 w-4 rounded-full bg-card shadow transition-transform ltr:data-[state=checked]:translate-x-4 rtl:data-[state=checked]:-translate-x-4"
      />
    </SwitchRoot>
